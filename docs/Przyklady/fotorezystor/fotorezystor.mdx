...
![Schemat podłączenia](./img/photoresistor.svg)

## Przykładowe podłączenie

![Przykładowe podłączenie](./img/photoresistor.jpeg)

<video
  controls
  src={require('./img/photoresistor.mp4').default}
  poster={require('./img/photoresistor-cover.jpg').default}
  width="620">

  <p>
    Download the
    <a href={require('./img/photoresistor.mp4').default}>MP4</a>
    video.
  </p>
</video>
